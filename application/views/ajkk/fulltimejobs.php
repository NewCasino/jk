<div class="row">
	...
	<div class="col-lg-9">
		...
		<div class="panel panel-og">
			<div class="panel-heading">FULLTIME JOBS</div>
			<div class="panel-body">
					<div class="row">
						<div class="col-md-12 position">
							<input type="hidden" id="count_post" value="<?=$count_post;?>" />
							<?php //var_dump($fulltimejobs);
								if(!empty($fulltimejobs)){
									foreach ($fulltimejobs as $key) { ?>
							<div class="col-md-12" id="search_item_holder">
								...
								<div class="col-md-3" style="border-left:1px solid #ddd;">
									<table style="margin-bottom:5px; margin-top:10px;">
										<tr>
											<td>
												<i class="icon-price-tag" data-toggle="tooltip" data-placement="top" title='Salary'></i>&nbsp;
											</td>
											<td>
										...
										<tr>
											<td>
												<i class="icon-alarm" data-toggle="tooltip" data-placement="top" title='Recruitment Duration'></i>
											</td>
											<td>
										...
										<tr>
											<td>
												<i class="icon-stopwatch" data-toggle="tooltip" data-placement="top" title='Schedule Type'></i>
											</td>
											<td>
												<span style='font-size:11px;'>
													<?= $key['sked_type'] ?>
										...
										<tr>
											<td>
												<i class="icon-office" data-toggle="tooltip" data-placement="top" title='Company Name'></i>
											</td>
											<td>
												<span style='font-size:11px;'>
						...
						<?php if(!empty($fulltimejobs)){ ?>
						<div class="col-md-4" ></div>						
						<div class="showmore col-md-4">
							<br/>
							<button class="btn btn-sm btn-warning btn-block" id="fulltimejobbtn">
								<img src="<?= AJKKIMGPATH . 'loader.gif'; ?>" width='15' height='15' class="jobsloader">
								SHOW MORE&nbsp;&nbsp;
