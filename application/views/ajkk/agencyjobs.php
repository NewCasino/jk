	...
	<div class="col-lg-9">
		<div class="panel panel-default">
			<div class="panel-body">
				<form action="<?= BASEURL. 'ajkk/searchAgencyJob' ?>" method="post">
					<div class="row">
							<div class="col-md-12">
								<div class="col-md-4">
		...
		<div class="panel panel-og">
			<div class="panel-heading">AGENCY JOBS</div>
			<div class="panel-body">
					<div class="row">
						...
						<?php if(!empty($agencyjobs)){ ?>
						<div class="col-md-4" ></div>						
						<div class="showmore col-md-4">
							<br/>
							<button class="btn btn-sm btn-warning btn-block" id="agencyjobbtn">
								<img src="<?= AJKKIMGPATH . 'loader.gif'; ?>" width='15' height='15' class="agencyjobsloader">
								SHOW MORE&nbsp;&nbsp;
