...
<div class="row">
    <div class="col-lg-12">
        <!-- <div class="well" style="overflow: auto"> -->
                    ...
                    <a class='notificationRefreshList' href="<?= BASEURL.'employers/applicantManager/0/1' ?>">
                    ...
                    <a class='notificationRefreshList' href="<?= BASEURL.'employers/applicantManager/1/1' ?>">
                    ...
                    <a class='notificationRefreshList' href="<?= BASEURL.'employers/applicantManager/2/1' ?>">
                    ...
                    <a class='notificationRefreshList' href="<?= BASEURL.'employers/applicantManager/3/1' ?>">
