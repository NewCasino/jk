...
<div class="row">
    <div class="col-lg-12">
        <!-- <div class="well" style="overflow: auto"> -->
                    ...
                    <a class='notificationRefreshList' href="<?= BASEURL.'employers/jobDetails/'.$jobInfodetails[0]['jobId'].'/0/1' ?>">
                        <div class="col-sm-2 col-md-2 col-lg-2 notificationDashboardInner hover-shadow <?= $this->session->userdata('jobDetailsCurrentPage') == 0 ? 'notDboard-active' : ''?>" >
                    ...
                    <a class='notificationRefreshList' href="<?= BASEURL.'employers/jobDetails/'.$jobInfodetails[0]['jobId'].'/1/1' ?>">
                        <div class="col-sm-2 col-md-2 col-lg-2 notificationDashboardInner hover-shadow  <?= $this->session->userdata('jobDetailsCurrentPage') == 1 ? 'notDboard-active' : ''?>" >
                    ...
                    <a class='notificationRefreshList' href="<?= BASEURL.'employers/jobDetails/'.$jobInfodetails[0]['jobId'].'/2/1' ?>">
                        <div class="col-sm-2 col-md-2 col-lg-2 notificationDashboardInner hover-shadow  <?= $this->session->userdata('jobDetailsCurrentPage') == 2 ? 'notDboard-active' : ''?>" >
                    ...
                    <a class='notificationRefreshList' href="<?= BASEURL.'employers/jobDetails/'.$jobInfodetails[0]['jobId'].'/3/1' ?>">
                        <div class="col-sm-2 col-md-2 col-lg-2 notificationDashboardInner hover-shadow  <?= $this->session->userdata('jobDetailsCurrentPage') == 3 ? 'notDboard-active' : ''?>" >
     ...
     <div class="col-lg-12">
        <div class="panel panel-og">
            <div class="panel-heading">
                <?= strtoupper($jobInfodetails[0]['job_title']); ?>
            </div>
            ...
            <div class="panel-body" style="border-top: 3px solid #366903;">
                <div id="jobs_table" class="table-responsive">
                         <table class="table table-striped table-hover" style="margin: 0px 0 0 0; width: 100%;" id='applicantTable'>
                            ...
                            <tbody>
                                 <?php $ctr = 1; ?>
                                    <?php //var_dump($jobInfodetails[0]['jobApplicants']);
                                        if(!empty($jobInfodetails[0]['jobApplicants'])) {  ?>
                                        <?php foreach ($jobInfodetails[0]['jobApplicants'] as $key) { ?>    
                                            <tr>
                                                <td></td>
                                                <td><?= $ctr ?></td>
                                                ...
                                                <?php }elseif($jobtype == 1){ ?>
                                                    <?php if($status == 0){//apply ?>
                                                            <a href="<?= BASEURL.'employers/assessJobApplicant/1/'.$key['jobId'].'/'.$key['applicantId'] ?>" class="btn btn-success btn-xs">Shortlist</a>
                                                            <a href="<?= BASEURL.'employers/assessJobApplicant/2/'.$key['jobId'].'/'.$key['applicantId'] ?>" class="btn btn-primary btn-xs">Set Interview</a>
                                                            <a href="<?= BASEURL.'employers/assessJobApplicant/3/'.$key['jobId'].'/'.$key['applicantId'] ?>" class="btn btn-danger btn-xs">Unqualified</a>
                                                    <?php }elseif($status == 1){//shortlisted ?>
                                                            <a href="<?= BASEURL.'employers/assessJobApplicant/2/'.$key['jobId'].'/'.$key['applicantId'].'/1' ?>" class="btn btn-primary btn-xs">Set Interview</a>
                                                    <?php }elseif($status == 2){//interview ?>
                                                            <a href="<?= BASEURL.'employers/assessJobApplicant/4/'.$key['jobId'].'/'.$key['applicantId'] ?>" class="btn btn-success btn-xs">Hired</a>
                                                            <a href="<?= BASEURL.'employers/assessJobApplicant/5/'.$key['jobId'].'/'.$key['applicantId'] ?>" class="btn btn-danger btn-xs">Failed</a>
                                                    <?php } ?>
                                                <?php } ?>
                                                </td>
                                            </tr>
